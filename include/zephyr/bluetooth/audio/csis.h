...
struct bt_csis_cb {
	 ...
	 *
	 * If this callback is not set, CSIS will handle advertising of the RSI.
	 *
	 * @param prsi Pointer to the new RSI data to be advertised.
	 */
	void (*prsi_changed)(const uint8_t *prsi);
};
